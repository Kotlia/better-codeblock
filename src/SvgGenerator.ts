...
export default function SvgGenerator(codeblock: Codeblock) {
    ...
    const height = 24 + 15.02 * (split.length + 1.8)
    const width = 39 + 7.4 * maxLength
    return `
<svg width="${width}px" height="${height}px" xmlns="http://www.w3.org/2000/svg">
    ...
    <switch>
        <foreignObject x="30px" width="${width}px" height="${height}px" requiredExtensions="http://www.w3.org/1999/xhtml">
